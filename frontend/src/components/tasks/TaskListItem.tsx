...
import { FaGlobe, FaInstagram, FaTelegramPlane, FaYoutube, FaUsers, FaExternalLinkAlt } from 'react-icons/fa';
...
const getPlatformIcon = (platform?: string, taskType?: string) => {
  ...
  if (p === 'web') return <FaGlobe size={20} className="text-violet-300" />;
