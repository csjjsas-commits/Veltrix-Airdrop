      ...
      <div className="space-y-10 rounded-[2.5rem] border border-slate-800/60 bg-slate-950/70 p-6 sm:p-8 lg:p-10 shadow-2xl shadow-slate-950/40 backdrop-blur-xl">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-3xl border border-slate-800/60 bg-slate-900/80 p-6">
            <p className="text-xs uppercase tracking-[0.35em] text-slate-500">Bienvenido de nuevo</p>
            <p className="mt-4 text-sm text-slate-400">Ingresa con tu cuenta para ver tu progreso y misiones.</p>
          </div>
          <div className="rounded-3xl border border-slate-800/60 bg-slate-900/80 p-6">
            <p className="text-xs uppercase tracking-[0.35em] text-slate-500">No tienes cuenta?</p>
            <p className="mt-4 text-sm text-slate-400">Regístrate para activar tu nodo y empezar a ganar tokens.</p>
          </div>
        </div>
      </div>
