        ...
        <div className="rounded-[2.5rem] border border-slate-800/70 bg-slate-900/90 p-10 shadow-2xl shadow-slate-950/40 backdrop-blur-xl">
          <div className="mb-10 max-w-xl">
            <div className="flex items-center gap-4 mb-6">
              <img src="/branding/logo.png" alt="Veltrix" className="h-12 w-12 object-contain" />
              <div>
            ...
            <h1 className="mt-6 text-4xl font-semibold text-white">Inicia sesión y descubre tu panel de progreso.</h1>
